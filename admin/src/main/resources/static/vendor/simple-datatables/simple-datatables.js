      ...
      (function (global) {
        (function () {
          ...
          var e = t((function (t, e) {
            t.exports = function () {
              var t = 1e3, e = 6e4, n = 36e5, r = "millisecond", i = "second", s = "minute", a = "hour", o = "day",
                u = "week", f = "month", h = "quarter", c = "year", d = "date", l = "Invalid Date",
                $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,
                M = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, m = {
                  name: "en",
              ...
              var O = function () {
                ...
                return D.parse = function (t) {
                  ...
                  var r = t || "YYYY-MM-DDTHH:mm:ssZ", i = w.z(this), s = this.$H, a = this.$m, o = this.$M,
                    u = n.weekdays, f = n.months, h = function (t, n, i, s) {
                  ...
                  var $, M = w.p(d), m = S(r), D = (m.utcOffset() - this.utcOffset()) * e, v = this - m,
                    p = w.m(this, m);
                  ...
                  if ("string" == typeof o) {
                    ...
                    f && (c = a[2]), s = this.$locale(), !u && c && (s = n.Ls[c]), this.$d = function (t, e, n) {
                      try {
                        ...
                        var r = d(e)(t), i = r.year, s = r.month, a = r.day, o = r.hours, u = r.minutes, f = r.seconds,
                          h = r.milliseconds, c = r.zone, l = new Date, $ = a || (i || s ? 1 : l.getDate()),
